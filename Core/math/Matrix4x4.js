...
export class Matrix4x4 {
  ...
  // SCALE.X * ROTATION.Z COS, ROTATION.Z SIN, 0, 0
  // 0, SCALE.Y * ROTATION.Z -COS, ROTATION.Z SIN, 0
  // 0, 0, SCALE.Z, 0
  // POS.X, POS.Y, POS.Z, 1
  ...
  static RotationXYZ(vector) {
    let rx = Matrix4x4.rotationX(vector.x * (Math.PI / 180))
    let ry = Matrix4x4.rotationY(vector.y * (Math.PI / 180))
    let rz = Matrix4x4.rotationZ(vector.z * (Math.PI / 180))
